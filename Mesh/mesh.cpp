...
IceMesh::IceMesh(const MeshParams& mp,
                 ...
                 const ModelParams& modp)
{
    ...
    if(ice_mesh->isParallelFileFormat(mp.GetMeshPath()))
    {
        ice_mesh->Load(mp.GetMeshPath()); 
        repartition = true;
    ...
    if (ice_mesh->GetProcessorRank()==0)
    {
        cout << "Mesh " << mp.GetMeshPath() << " loaded successfully " << endl;
